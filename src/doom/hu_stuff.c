...
void HU_Drawer(void)
{
	...
	M_snprintf(str, sizeof(str), "\x1b%cA: \x1b%c%-5d", '0' + CR_TAN, '0' + CR_GRAY,
	...
	M_snprintf(str, sizeof(str), "\x1b%cX: \x1b%c%-5d", '0' + CR_TAN, '0' + CR_GRAY,
	...
	M_snprintf(str, sizeof(str), "\x1b%cY: \x1b%c%-5d", '0' + CR_TAN, '0' + CR_GRAY,

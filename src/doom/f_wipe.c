...
{
    if (widescreen)
        wipe_scr_start = Z_Malloc(WIDESCREENWIDTH * SCREENHEIGHT * sizeof(*wipe_scr_start), PU_STATIC, NULL);
    else
...
{
    if (widescreen)
        wipe_scr_end = Z_Malloc(WIDESCREENWIDTH * SCREENHEIGHT * sizeof(*wipe_scr_end), PU_STATIC, NULL);
    else
